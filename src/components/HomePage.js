  ...
  return (
    <div className="home-page">
      ...
      <div className="main-actions">
        <Link to="/report" className="action-card report-card">
          <h3>Report an Accident</h3>
          <p>Quickly report incidents with photos and details</p>
        </Link>
        
        <Link to="/assistance" className="action-card assistance-card">
          <h3>Get Assistance</h3>
          <p>Connect with medical professionals instantly</p>
        </Link>
        
        <Link to="/locator" className="action-card locator-card">
